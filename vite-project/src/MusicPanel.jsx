        ...
        <div className="music_panel_area">
            <div className="music_panel">
                <div className="track_panel_buttons">
                    <button className="svg_icons_panel_svg" onClick={() => {/* Обработчик воспроизведения предыдущей дорожки */}}>
                        {/* SVG для предыдущей дорожки */}
                        <svg className="svg_icons_panel_button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    ...
                    <button className="svg_icons_panel_svg" onClick={() => {/* Обработчик воспроизведения следующей дорожки */}}>
